...
The focus is on understanding the algorithmic structure, optimization dynamics, and practical design choices that improve performance on classification tasks.
...
- inputs are normalized and largely centered near zero  ?????
